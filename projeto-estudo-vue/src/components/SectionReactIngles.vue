<template>
  <section class="sobre" id="sobre">
    <div class="sobre-info">
      <h1>About</h1>
      <p>
        React is a declarative, efficient and flexible JavaScript library to
        create user interfaces. It allows you to compose complex UIs at from
        small and isolated codes called “components”
      </p>
    </div>
    <div class="sobre-img">
      <iframe
