...
Vue is a progressive framework for building user interfaces.
         user. Unlike other monolithic frameworks, Vue was
         designed from inception to be incrementally adoptable. THE
         core library is focused exclusively on the visual layer (view
         layer), being easy to adopt and integrate with other libraries or projects
         existing.
      </p>
    </div>
    <div class="sobre-img">
