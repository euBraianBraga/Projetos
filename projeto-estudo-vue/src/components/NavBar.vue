      ...
      <div class="menu">
        ...
        <nav class="menu-nav">
          <ul>
            ...
            <li><a href="#produto">Curso</a></li>
            <li><a href="#preco">Recomendações</a></li>
            <li><a href="#qualidade">Depoimentos</a></li>
            <li>
              <a href="/postsIngles">
                <img
...
export default {
  data() {
    return {
      contatoWhats:
        '<a target="_blank" style="color: white; font-weight: bold" href="https://api.whatsapp.com/send?phone=5511974093996&text=Estou%20com%20duvidas%20sobre%20o%20blog%20de%20VUE%2C%20poderia%20me%20ajudar%20%3F">Não entendeu algo ? Entre em contato com a gente</a>',
    };
  },
};
</script>
